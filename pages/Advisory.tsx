                        ...
                        <div key={idx} className={`flex ${msg.role === 'user' ? 'justify-end' : 'justify-start'} group relative`}>
                            ...
                            {msg.role === 'model' && (
                                <button 
                                    ...
                                    className="absolute left-[calc(100%-25px)] md:left-auto md:ml-2 bottom-0 opacity-0 group-hover:opacity-100 transition text-gray-400 hover:text-pru-red w-6 h-6 flex items-center justify-center bg-gray-100 dark:bg-gray-800 rounded-full shadow-sm"
                                    title="Copy cho Zalo"
                                    style={{left: 'auto', right: '-30px', bottom: '5px'}}
                                >
